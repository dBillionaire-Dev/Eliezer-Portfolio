        ...
        <div className='lg:px-15 px-5 py-5 bg-red-50 lg:h-175 h-250  w-[94%] m-[auto] flex lg:flex-row flex-col'>
            <section>
                ...
                <span className='flex lg:flex-row md:flex-row md:gap-5 flex-col lg:justify-start md:justify-evenly lg:gap-5'>
                    <button className="bg-black hover:bg-gray-400 text-white hover:text-black py-4 lg:px-15 px-10 xl:px-5 lg:pt-6 lg:pb-8 mb-8 rounded-2xl lg:text-3xl text-2xl font-normal justify-around"><Link to="/project" className="flex flex-row">View My Work <FaArrowRightToBracket className='relative top-1 lg:left-2 left-5' /></Link></button>
                    <button className="bg-gray-400 hover:bg-gray-900 text-black hover:text-white py-4 xl:px-5 px-10 lg:pt-6 lg:pb-8 mb-8 rounded-2xl lg:text-3xl text-2xl font-normal flex flex-row lg:gap-3 justify-around"><a className='flex flex-row' href="/files/Eliezer_Ekunke_Resume.pdf" download>Download My CV <FaFileLines className='relative top-1 left-1' /></a></button>
                </span>
            </section>
            <section>
