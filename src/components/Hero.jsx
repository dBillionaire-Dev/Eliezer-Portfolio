        ...
        <div className='lg:px-15 px-5 py-5 bg-red-50 lg:h-[95vh] h-250  w-[94%] m-[auto] flex lg:flex-row flex-col'>
            <section>
                ...
                <span className='flex lg:flex-row flex-col lg:justify-start lg:gap-5'>
                    <button className="bg-black hover:bg-gray-400 text-white hover:text-black py-4 lg:px-15 px-10 lg:pt-6 lg:pb-8 mb-8 rounded-2xl lg:text-3xl text-2xl font-normal justify-around"><Link to="/project" className="flex flex-row">View My Work <FaArrowRight className='relative top-1 lg:left-2 left-5' /></Link></button>
