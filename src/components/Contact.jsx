...
const Contact = () => {
    ...
    return (
        <div className={`transition-all duration-500 overflow-hidden ${showForm ? 'lg:h-120' : 'lg:h-[20vh]'} rounded-xl w-[94%] m-[auto] lg:px-15 px-5 pt-5 pb-3 flex lg:flex-row flex-col lg:gap-x-90 lg:mb-3`} id='contact' >
            <div>
            ...
            {showPopup && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-2xl shadow-2xl text-center max-w-sm animate-bounce-in">
                        ...
                        <p className="text-lg text-gray-700">Your message has been sent successfully. I’ll reach out soon!</p>
                        <button
            ...
            <div>
                {!showForm && (
                    <button onClick={handleClick} className="bg-black hover:bg-gray-400 text-white hover:text-black py-4 lg:px-5 px-8 lg:pt-4 lg:pb-6 mb-5 rounded-2xl lg:text-3xl text-2xl font-normal self-center transition shadow-emerald-500">Contact Me</button>
                )}
