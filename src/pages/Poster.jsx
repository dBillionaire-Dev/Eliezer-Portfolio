...
const Poster = () => {
    ...
    return (
        <div className='w-[100%] mb-5'>
            <BackToTop />
            <div className="lg:pt-5 lg:pb-1 w-[97%] bg-black relative mt-3 m-[auto] text-white text-lg font-semibold flex lg:justify-around lg:gap-250 xl:gap-190 justify-between shadow-2xl rounded-2xl">
