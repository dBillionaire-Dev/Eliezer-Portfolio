...
import { Palette, Megaphone, Layout, Printer, Globe } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex justify-center items-center space-x-8 mt-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-pink-600 rounded-lg flex items-center justify-center mb-2">
                <span className="text-white font-bold text-xl">Id</span>
              </div>
              <p className="text-gray-300 text-sm">InDesign</p>
            </div>
          </div>
        </div>
      </div>
