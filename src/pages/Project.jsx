...
const Project = () => {
    ...
    return (
        <div className='w-[100%]'>
            <BackToTop />
            <div className="lg:pt-5 lg:pb-1 w-[97%] bg-black relative mt-3 m-[auto] text-white text-lg font-semibold flex lg:justify-around lg:gap-150 xl:gap-100 justify-between shadow-2xl rounded-2xl">
